 ...
 *     - name:          display name
 *     - prerequisites: (optional) array of topic IDs from the same course that should
 *                      be partially mastered before this topic is attempted. Omit or
 *                      leave empty ([]) for no prerequisites. The first topic in a
 *                      course should never have prerequisites — it is the entry point.
 *                      Example: prerequisites: ["intro-topic-id"]
  ...
  // ─────────────────────────────────────────────────────────────────
  {
    ...
    topics: [
      ...
      },
      {
        ...
        prerequisites: ["topic-mc"],   // topic-mc should be attempted first
        problems: [
          {
